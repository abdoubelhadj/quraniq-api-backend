...
import numpy as np
import faiss
import torch # <-- Réintroduit
from transformers import AutoTokenizer, AutoModel # <-- Réintroduit
...
class QuranIQChatbot:
    def __init__(self):
        ...
        self.chunks = []
        self.metadata = []
        self.tokenizer = None # <-- Réintroduit
        self.embedding_model = None # <-- Réintroduit
